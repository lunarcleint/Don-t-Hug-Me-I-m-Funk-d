...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Play Animation', "Plays an animation on a Character,\nonce the animation is completed,\nthe animation changes to Idle\n\nValue 1: Animation to play.\nValue 2: Character (Dad(2), BF(2), GF)"],
		['Camera Follow Pos', "Value 1: X\nValue 2: Y\n\nThe camera won't change the follow point\nafter using this, for getting it back\nto normal, leave both values blank."],
		['Alt Idle Animation', "Sets a specified suffix after the idle animation name.\nYou can use this to trigger 'idle-alt' if you set\nValue 2 to -alt\n\nValue 1: Character to set (Dad(2), BF(2) or GF)\nValue 2: New suffix (Leave it blank to disable)"],
		['Screen Shake', "Value 1: Camera shake\nValue 2: HUD shake\n\nEvery value works as the following example: \"1, 0.05\".\nThe first number (1) is the duration.\nThe second number (0.05) is the intensity."],
		['Change Character', "Value 1: Character to change (Dad(2), BF(2), GF)\nValue 2: New character's name"],
		['Change Scroll Speed', "Value 1: Scroll Speed Multiplier (1 is default)\nValue 2: Time it takes to change fully in seconds."],
		['Toggle Bf Characters', "Value 1: Toggle Bf2\nValue 2: Toggle Bf"],
		['Toggle Dad Characters', "Value 1: Toggle Dad2\nValue 2: Toggle Dad"],
		['Change Stage', "Value 1: The Stage\n"],
		['Fade In/Out', "Value 1: in/out\nValue 2: speed"],
		['Fade HealthBar In/Out', "Value 1: in/out\nValue 2: speed"],
		['Set Zoom', "Value 1: zoom\nValue 2: time"],
		['Reset Cam Zoom', "balls me when"],
	];
